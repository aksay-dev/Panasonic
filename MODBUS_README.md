# MODBUS Slave для теплового насоса Panasonic Aquarea
...
| 0x0019 | z2_room_temp | int16 | Температура помещения зоны 2, °C |
...
| 0x003C | main_schedule_state | 0/1 | Состояние основного расписания |
...
#### Дополнительные команды (0x1010-0x1015)
| Адрес | Команда | Значения | Описание |
|-------|---------|----------|----------|
...
#### Температурные уставки (0x1020-0x1028)
...
| 0x1025 | set_bivalent_start_temp | °C*100 | Температура запуска бивалентного режима |
| 0x1026 | set_bivalent_ap_start_temp | °C*100 | Температура запуска AP режима |
| 0x1027 | set_bivalent_ap_stop_temp | °C*100 | Температура остановки AP режима |
| 0x1028 | set_heating_off_outdoor_temp | °C*100 | Температура отключения отопления |
...
### Coils (0x2000-0x2FFF) - Быстрые команды
